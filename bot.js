...
client.on('message', msg => {
  ...
  if (msg.content === '!quotelist') {
    msg.channel.send('Here are the prefixes for the ![prefix]quote command. You can also get a random quote with !quote **ty**, **chris**, **scott**, **kristyn**, **eth**, **austin**, **thunder**, **devan**, **jake**, **alex**, **megan**, **beth**, **troy**, **laurel**, **npc**. '); } 
