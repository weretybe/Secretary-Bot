...
client.on('message', msg => {
  ...
  if (msg.content === '!version') {
    msg.channel.send('I am Secretary Bot 2.24. I have added 5 new quotes, 5 new haiku, and fixed a coding problem that no one but Ty knew about.'); }
