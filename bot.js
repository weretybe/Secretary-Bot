...
client.on('message', msg => {
  ...
  if (msg.content === '!version') {
    msg.channel.send('I am Secretary Bot 2.18 I can now predict the future with tarot1 or tarot3, call any quote with !quote, and am changing the function of the quotelist command'); }
