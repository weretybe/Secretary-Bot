...
client.on('message', msg => {
  ...
  if (msg.content === '!version') {
    msg.channel.send('I am Secretary Bot 2.18.2 I can now predict the future with tarot1 or tarot3, call any quote with !quote, and am changing the function of the quotelist command. Also, I added 8 quotes, 6 haiku, and 10 images'); }
  ...
  if (msg.content === '!quotelist') {
    msg.channel.send('Here are the prefixes for the ![prefix]quote command. You can also get a random quote with !quote **ty**, **chris**, **scott**, **kristyn**, **eth**, **austin**, **thunder**, **devan**, **jake**, **sully**, **megan**, **beth**, **troy**, **laurel**, **npc**. '); } 
...
function thunderquote() {
    ...
    return(valueToUse) }  
function devanquote() {
    var values = ["'My god man Jennifer Lawrence’s ass isn’t even that big.' - Dev, 2021","'That's a classic hump and whump' - Dev 2021","'I know myself well enough to know I would never stop at one crime.' -Dev, 2021","'My favorite of triathlons. Creative driving, canoeing, and throwing hands.' - Dev, 2021","'I’ll waterboard a literal goat all damn day if they had nuclear launch codes.' - Dev 2021","'I am full of many nuts and none regrets.' - Devan Horn, 2021","'Ahegao is in your heart' - Devan Horn, 2020","'America is a continent you warm disaster' - Dev 2019","'So now I’m drinking my home coffee so I can drink my first work coffee.' - Devan Horn, 2020.","'Now hang on just a darn toot'in minute. How the floppy fuck can someone be anti-pony?' - Devan Horn, 2017","'[Jake], did you dick the gas outta my car?!?' - Devan Horn, 2020","'I think Saw could be like, way sexier' - Devan Horn, 2020","'In all honesty it was a really fair and rational genocide' - Devan Horn, 2018","'All neko genitalia are valid!' - Devan Horn, 2020"]
        valueToUse = values[Math.floor(Math.random() * values.length)]
    return(valueToUse) }
function sullyquote() {
