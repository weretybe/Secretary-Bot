...
client.on('message', msg => {
  ...
  if (msg.content === '!version') {
    msg.channel.send('I am Secretary Bot 2.23. I made Alyssa a little code house and tucked her quotes in so they wouldnt be cold.'); }
...
function alexquote() {
    ...
    return(valueToUse) }	
function jakequote() {
    var values = ["'Roll intelligence to realize you’re the problem' - Jake 2019","'I believe in your testicles, Troy' - Jake, 2019","'Oooo baby. I just wanna lay ya down a platonically watch a movie together so bad.' - Jake, 2020","'Now the avatar must master the 4 elements; Gun, Bear, Man, and Woman' - Jake, 2020","'If you make a $1,000 on a B&E you’re breaking and escorting' - Jake, 2021","'Cocaine is the past. Meth is the future' - Jake, 2021","'Are there wizards in the Taliban?' - Jake, 2021","'Scott’s vision is based on horny movement' - Jake, 2021"]
        valueToUse = values[Math.floor(Math.random() * values.length)]
    return(valueToUse) }     
function bethquote() {
