...
client.on('message', msg => {
  ...
  if (msg.content === '!version') {
    msg.channel.send('I am Secretary Bot 2.14. Ty fixed the Haiku-as-an-image problem.'); }
